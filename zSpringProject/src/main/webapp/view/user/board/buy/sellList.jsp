				...
				<div class="container">
					<div class="row">
						...
						<div class="writebutton">
							<input type="submit"  class="w3-button w3-round-large w3-tiny " style="background-color: #f0e68c;" onclick="location.href='${pageContext.request.contextPath}/board/write'" value="글쓰기">
						</div>					
							<p></p>
									...
									<a href="#" class="list-group-item">
										<div class="media col-md-3">
											<figure class="pull-left">
												<img class="media-object img-rounded img-responsive" src="${pageContext.request.contextPath}/uploadFile/${list.filename}"  alt=""></figure>
										</div>
										<div class="col-md-6">
											<!-- 반복문으로 돌린다 -->
											<table>
